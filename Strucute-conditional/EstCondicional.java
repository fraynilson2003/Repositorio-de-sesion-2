...
class EstCondicional{
  ...
  System.out.println("El monto a pagar es:"+montoP);
    ...
    System.out.println("Error en introduccion de datos!!, por favor vuela a intentarlo");
  }
  }
...
static void ejercicio02(){
  ...
  double montoP;
  //Datos de Entrada
  System.out.println("Ingrese la cantidad de personas indicadas");
  cantidadX=teclado.nextInt();
  //Proceso
  if(cantidadX<=200){
    montoP=cantidadX*95;
  ...
  //Datos de salida
  System.out.println("E monto a pagar es:"+montoP);
  }
